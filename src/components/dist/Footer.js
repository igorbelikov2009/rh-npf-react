    ...
    return (react_1["default"].createElement("footer", { className: "footer" },
        ...
        react_1["default"].createElement("div", { className: "footer__content" },
            react_1["default"].createElement("div", { className: "footer__nav" },
                ...
                react_1["default"].createElement("div", { className: "footer__column" }, ThirdBlock.map(function (link) { return (react_1["default"].createElement(FooterLink_1["default"], { key: link.to, to: link.to }, link.children)); })),
