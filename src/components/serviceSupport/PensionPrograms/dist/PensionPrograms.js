...
var PensionPrograms = function () {
    return (react_1["default"].createElement("section", { className: PensionPrograms_module_scss_1["default"]["pension-programs"] },
        ...
        serviceSupportData_1.pensionPrograms.map(function (obj, index) { return (react_1["default"].createElement(ExpandingAnswer_1["default"], { key: index, question: obj.question, answer: obj.answer, isParagraph: obj.isParagraph, isParagraphBefore: obj.isParagraphBefore })); })));
};
