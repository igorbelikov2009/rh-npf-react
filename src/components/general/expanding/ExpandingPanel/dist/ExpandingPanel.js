...
var ExpandingPanel = function (_a) {
    var isContentVisible = _a.isContentVisible, tableName = _a.tableName, onClickExpanding = _a.onClickExpanding;
    return (react_1["default"].createElement("div", { className: ExpandingPanel_module_scss_1["default"]["expanding__row"], onClick: onClickExpanding },
        react_1["default"].createElement("h2", { className: ExpandingPanel_module_scss_1["default"]["expanding__title"] }, tableName),
