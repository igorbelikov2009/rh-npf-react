...
var DocumentsOfTitle = function () {
    return (react_1["default"].createElement("section", { className: DocumentsOfTitle_module_scss_1["default"]["documents-of-title"] },
        react_1["default"].createElement("div", { className: DocumentsOfTitle_module_scss_1["default"]["documents-of-title__container"] },
            ...
            react_1["default"].createElement("div", { className: DocumentsOfTitle_module_scss_1["default"]["documents-of-title__list"] }, InfoDisclosurePageData_1.linksDocumentsOfTitle.map(function (link, index) { return (react_1["default"].createElement(ArchiveLink_1["default"], { key: index, href: link.href, title: link.title })); })))));
};
