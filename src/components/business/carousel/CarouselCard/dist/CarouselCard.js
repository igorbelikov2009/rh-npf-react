...
var CarouselCard = function (_a) {
    ...
    return (react_1["default"].createElement("label", { className: isActive ? CarouselCard_module_scss_1["default"]["carousel__card_actived"] : CarouselCard_module_scss_1["default"]["carousel__card"], onMouseOver: function () { return setIsHovered(true); }, onMouseOut: function () { return setIsHovered(false); } },
        ...
        react_1["default"].createElement("p", { className: CarouselCard_module_scss_1["default"]["carousel__title"] }, title)));
};
