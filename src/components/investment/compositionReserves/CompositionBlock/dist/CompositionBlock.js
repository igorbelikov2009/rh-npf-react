...
// interface IExpandingTable {
//   tableName: string;
//   headings: string[];
//   arrayRows: string[][];
// }
var CompositionBlock = function () {
    var oneExpandingTable = {
    ...
    //   )}
    // </>
    react_1["default"].createElement(react_1["default"].Fragment, null, arrayOfExpanderTables.map(function (expander, index) { return (react_1["default"].createElement(ExpandingTable_1["default"], { key: index, oneExpandingTable: expander })); }))
    // <div>
    //   <ExpandingTable oneExpandingTable={oneExpandingTable} />
