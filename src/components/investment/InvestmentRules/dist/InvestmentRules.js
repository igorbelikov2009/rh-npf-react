...
var InvestmentRules = function () {
    ...
    return (react_1["default"].createElement("div", { className: InvestmentRules_module_scss_1["default"]["investment-rules"] },
        ...
        react_1["default"].createElement("div", { className: InvestmentRules_module_scss_1["default"]["investment-rules__row"] }, cards.map(function (card, index) { return (react_1["default"].createElement(InvestmentRulesCard_1["default"], { key: index, icon: card.icon, title: card.title })); }))));
};
