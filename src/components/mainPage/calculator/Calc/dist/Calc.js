...
var Calculator = function () {
    var genderValue = 65; // гендерный возраст выхода на пенсию
    var ageValue = 30; // текущий возраст
    var numberOfYears = 35; // срок инвестирования
    var firstInvestValue = ""; // первичный взнос
    var monthInvestValue = ""; // ежемесячный взнос
    var timePaymentsValue = ""; // срок выплат пенсии
    var yearPersent = 0.05; // годовой процент накопления
    var generalAccumValue = 5143933; // общие накопления
    var pensionValue = 28577; // размер выплаты пенсии
    var radioItems = [
        { value: 65, title: "М" },
        { value: 60, title: "Ж" },
    ];
                        ...
                        react_1["default"].createElement("form", { className: Calc_module_scss_1["default"]["slider-block"] },
                            react_1["default"].createElement("div", { className: Calc_module_scss_1["default"]["slider-block__age"] },
                                react_1["default"].createElement("div", { className: Calc_module_scss_1["default"]["slider-block__switch"] },
                                    react_1["default"].createElement(RadioSecondary_1["default"], { radioItems: radioItems })),
                            ...
                            react_1["default"].createElement("div", { className: Calc_module_scss_1["default"]["slider-block__checkbox"] },
                                react_1["default"].createElement("label", { role: "checkbox", "aria-checked": "false", "aria-labelledby": "foo", className: Calc_module_scss_1["default"]["r-checkbox"] },
                                    ...
                                    react_1["default"].createElement("button", { className: "r-checkbox__switch r-checkbox__switch_invisible" }),
                                    react_1["default"].createElement("input", { id: "Checkbox", type: "checkbox", className: Calc_module_scss_1["default"]["r-checkbox__input"] }),
                                    react_1["default"].createElement("div", { className: "r-checkbox__agree-link" }, "\u0423\u0447\u0438\u0442\u044B\u0432\u0430\u0442\u044C \u0441\u043E\u0446\u0438\u0430\u043B\u044C\u043D\u044B\u0439 \u043D\u0430\u043B\u043E\u0433\u043E\u0432\u044B\u0439 \u0432\u044B\u0447\u0435\u0442"))),
