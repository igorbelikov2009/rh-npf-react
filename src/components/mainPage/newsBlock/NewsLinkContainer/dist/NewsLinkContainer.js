...
var NewsLinkContainer = function (_a) {
    ...
    var _b = react_1.useState(""), linkContainerWidth = _b[0], setLinkContainerWidth = _b[1];
    return (react_1["default"].createElement("article", { className: isClear ? NewsLinkContainer_module_scss_1["default"]["container__clear"] : NewsLinkContainer_module_scss_1["default"]["container__blurry"] },
