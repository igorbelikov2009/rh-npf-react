...
var MenuMobil = function (_a) {
    var closeMenuMobil = _a.closeMenuMobil;
    var navigate = react_router_dom_1.useNavigate();
    var _b = react_1.useState(true), isBackgroundWhite = _b[0], setIsBackgroundWhite = _b[1];
    var topLinks = [
    ...
    return (react_1["default"].createElement("section", { className: "menu-mobil" },
        react_1["default"].createElement("div", null,
            react_1["default"].createElement("div", { className: "menu-mobil__logos", onClick: function () { return navigate("/", { replace: true }); } },
