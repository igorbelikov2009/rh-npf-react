...
exports.fetchUsers = function () { return function (dispath) { return __awaiter(void 0, void 0, void 0, function () {
    var response, e_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                dispath(UserSlice_1.userSlice.actions.userFetching());
            ...
            case 1:
                ...
                dispath(UserSlice_1.userSlice.actions.userFetchingSuccess(response.data));
                return [3 /*break*/, 3];
            case 2:
                e_1 = _a.sent();
                // Как payload, передаём туда некоторое сообщение об ошибке
                // Само сообщение мы получим из объекта error в поле (e.message)
                dispath(UserSlice_1.userSlice.actions.userFetchingError(e_1.message));
                return [3 /*break*/, 3];
